...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-3 col-md-3">
            @include('judi.analysis._partials._filter', [
                'route' => 'judi.analysis.criteria'
            ])
        </div>
                    ...
                    @if($data)
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#tabular" aria-controls="tabular" role="tab" data-toggle="tab">Tabular</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active padding-top-2x" id="tabular">
                                @include('judi.analysis._partials._summaries')
                            </div>

                            <div role="tabpanel" class="tab-pane padding-top-2x" id="summary">
                                @include('judi.analysis._partials._summaries-summarised')
                            </div>
                        </div>
                    @else
                        <p>
