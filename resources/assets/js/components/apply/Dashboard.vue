                    ...
                    <div class="panel-heading">
                        <h5 class="text-upper weight-bold">
                            <small class="pull-right badge">
                                {{ moment(data.contractYear.start, 'YYYY-MM-DD').format('YY') }}/
                                {{ moment(data.contractYear.end, 'YYYY-MM-DD').format('YY') }}
                            </small>
                            Programme Breakdown
                        </h5>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr v-for="programme in data.programmes">
